...
type Resource struct {
	...
	AvailableEventEmitter       *eventemitter.EventEmitter
	RemovingEventEmitter        *eventemitter.EventEmitter
	StatusUpdatedEventEmitter   *eventemitter.EventEmitter
	ProgressUpdatedEventEmitter *eventemitter.EventEmitter
}
...
func NewResource(resourceHandler ResourceHandler, resourcePath string, allowedFiles []string) *Resource {
	return &Resource{
		...
		Status:                      PENDING,
		AvailableEventEmitter:       new(eventemitter.EventEmitter),
		RemovingEventEmitter:        new(eventemitter.EventEmitter),
		StatusUpdatedEventEmitter:   new(eventemitter.EventEmitter),
		ProgressUpdatedEventEmitter: new(eventemitter.EventEmitter),
	}
}
